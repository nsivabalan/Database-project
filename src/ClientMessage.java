...
public class ClientMessage extends MessageBase{
	...
	//read
	public ClientMessage(String source,MessageType type,Integer transNo, String readObject,String qualifier)
	{
		this.source = source;
		this.type = type;
	...
	//write
	public ClientMessage(String source,MessageType type,Integer transNo, String writeObject, String qual, String value)
	{
		this.source = source;
		this.type = type;
		this.TransactionNo = transNo;
